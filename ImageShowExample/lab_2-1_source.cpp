...
int main(int argc, const char *argv[]) {
  ...
  for (int y = 0; y < image_size.height; y++) {
    ...
    ofs.seekp(y)
        // you could use "cv::Mat::ptr()" to get the pointer of the
        // corresponding row. you also have to count how many bytes to write to
        // the buffer http://www.cplusplus.com/reference/ostream/ostream/write/
        // https://docs.opencv.org/3.4.7/d3/d63/classcv_1_1Mat.html#a13acd320291229615ef15f96ff1ff738
        ofs.write(image.ptr(y), image_size.width * fb_info.bits_per_pixel / 8);
  }
...
get_framebuffer_info(const char *framebuffer_device_path) {
  ...
  // and return it." fb_info.xres_virtual =       // 8 fb_info.bits_per_pixel =
  // // 16
